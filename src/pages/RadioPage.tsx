...
import { Play, Pause, SkipBack, SkipForward, Volume2, Heart, Share2, Radio as RadioIcon, Coins, Loader2, AlertCircle, ExternalLink } from "lucide-react";
      ...
      <div className="px-4 py-6">
        ...
        <div className="rounded-3xl overflow-hidden gradient-card shadow-card border border-border p-6">
          ...
          <div className="flex items-center justify-center gap-3 mt-3">
            <a href="https://open.spotify.com/search/relax%20salon%20music" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-1.5 px-4 py-2 rounded-full bg-[#1DB954]/10 text-xs font-semibold text-[#1DB954] hover:bg-[#1DB954]/20 transition-colors">
            ...
            <a href="https://www.youtube.com/results?search_query=salon+relax+music+playlist" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-1.5 px-4 py-2 rounded-full bg-[#FF0000]/10 text-xs font-semibold text-[#FF0000] hover:bg-[#FF0000]/20 transition-colors">
              <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
