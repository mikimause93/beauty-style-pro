...
export default function RadioPage() {
  ...
  const sourceTabs: { key: MusicSource; label: string; color: string; icon: React.ReactNode }[] = [
    ...
    { key: "spotify", label: "Spotify", color: "text-success", icon: <SpotifyIcon className="w-4 h-4" /> },
    { key: "youtube", label: "YouTube", color: "text-live", icon: <YouTubeIcon className="w-4 h-4" /> },
  ];
    ...
    <MobileLayout>
      ...
      <div className="px-4 py-6">
        ...
        {source === "spotify" && (
          <div className="fade-in">
            <div className="flex items-center gap-2 mb-4">
              <svg viewBox="0 0 24 24" className="w-6 h-6 fill-success">
        ...
        {source === "youtube" && (
          <div className="fade-in">
            <div className="flex items-center gap-2 mb-4">
              <svg viewBox="0 0 24 24" className="w-6 h-6 fill-live">
