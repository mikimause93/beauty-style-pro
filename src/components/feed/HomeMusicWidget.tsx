        ...
        {source === "spotify" && (
          <div className="px-4 py-3">
            ...
            <div className="flex gap-2 mt-2 overflow-x-auto no-scrollbar">
              {["Peaceful Piano", "Spa & Relax", "Chill Hits"].map(name => (
                <button
                  key={name}
        ...
        {source === "youtube" && (
          <div className="px-4 py-3">
            <div className="rounded-xl overflow-hidden aspect-video">
              <iframe
                src="https://www.youtube.com/embed/videoseries?list=PLDfKAXSi6kOaiaFt8vMiJJMLNBeqaSMP8&autoplay=0"
                width="100%"
                height="100%"
                frameBorder="0"
            ...
            <div className="flex gap-2 mt-2 overflow-x-auto no-scrollbar">
              {["Salon Relax", "Lofi Beats", "Piano"].map(name => (
                <button
                  key={name}
                  onClick={() => navigate("/radio")}
